...
return {
  ...
  dependencies = {
    ...
    'https://codeberg.org/mfussenegger/nvim-dap-python',-- Python
  },
  keys = {
    ...
    { '<leader>df', function() require('dap').step_out() end, desc = 'Debug: Step Out' },
    ...
    -- { '<leader>dT', function() require('dapui').terminate() end, desc = 'Debug: Terminate Session' },
  },
  config = function()
